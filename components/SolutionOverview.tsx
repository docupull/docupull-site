const points = [
  {
    ...
    title: "Search",
    description: "AI searches county records across all 50 states, retrieving the right documents for each order.",
  },
  {
    icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",
    title: "Compilation",
    description: "Raw records assembled into a structured search package — no manual sorting.",
  },
  {
    icon: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
    title: "Report Generation",
    description: "Title reports and legal descriptions generated automatically. Seconds, not hours.",
  },
  {
    icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z",
    title: "Issue Detection",
    description: "Missing deeds, open mortgages, and chain breaks flagged on every order — before they reach your client.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-400 mt-4 max-w-xl mx-auto">
            Search. Compile. Generate. Flag. DocuPull replaces your workflow with a single platform.
          </p>
        </div>
